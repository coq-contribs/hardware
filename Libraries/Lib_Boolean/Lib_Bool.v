...
intros; elim (orb_false a b); auto with v62.
Qed.
...
simple induction b1; auto with v62.
Qed.
...
intros; elim (andb_true a b); auto with v62.
Qed.
...
apply andb_negb_true_r with b; auto with v62.
Qed.
